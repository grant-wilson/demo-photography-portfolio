      ...
      <div class="content">
        <ul class="contact-info">
          ...
          >
            ...
            <div
              style="align-self: stretch; height: 92px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: flex"
            >
              <div
                style="align-self: stretch; color: black; font-size: 20px; font-weight: 700; line-height: 28px; word-wrap: break-word"
              >
                Email
              </div>
              <div
                style="align-self: stretch; color: black; font-size: 16px; font-weight: 400; line-height: 24px; word-wrap: break-word"
              >
                Send us an email
              </div>
              <div
                style="align-self: stretch; color: black; font-size: 16px; font-weight: 400; text-decoration: underline; line-height: 24px; word-wrap: break-word"
              >
                demo@example.com
              </div>
            </div>
          ...
          >
            ...
            <div
              style="align-self: stretch; height: 108px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: flex"
            >
              <div
                style="align-self: stretch; color: black; font-size: 20px; font-weight: 700; line-height: 28px; word-wrap: break-word"
              >
